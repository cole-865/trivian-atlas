...
comment on column public.account_payment_signals.scheduled_payment_amount
  is 'Estimated recurring scheduled installment for payment ratios. Prefers normalized monthly_payment_amount and falls back to parsing Monthly Payment from raw_data for deployments that imported the new report before mapper code was deployed.';
